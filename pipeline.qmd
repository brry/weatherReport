...
## data info
Percentage of infants that are vaccinated per year and country.  
Data source: UNICEF Immunization coverage by antigen (country, regional, and global trends), see   <https://data.unicef.org/resources/dataset/immunization/> and the
[exact url](https://data.unicef.org/resources/data_explorer/unicef_f/?ag=UNICEF&df=GLOBAL_DATAFLOW&ver=1.0&dq=.IM_BCG+IMMUNISATION+IM_DTP1+IM_DTP3+IM_HEPB3+IM_HEPBB+IM_HIB3+IM_IPV1+IM_MCV1+IM_MCV2+IM_PCV3+IM_POL3+IM_RCV1+IM_ROTAC+IM_YFV..&startPeriod=2010&endPeriod=2020&lastnobservations=1)
...
- optionally, convert the list to an array
(complicated, so code is provided:)
